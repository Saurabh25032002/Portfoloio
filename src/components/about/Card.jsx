...
function Card() {
  return (
    ...
    <h2 className='text-green-600 text-lg'>About Me</h2> 
      <h5>Hey there! I'm Saurabh Panwar, a third-year Computer science and Engineering student at the Institute of Engineering and Technology, Lucknow. I'm passionate about frontend web development and currently exploring the MERN stack (MongoDB, Express.js, React, and Node.js).</h5>
     <h2  className='text-green-600 text-lg'> My Journey</h2>
    <h5>I discovered my love for programming and web development during my starting year at college. Since then, I've been on a journey of continuous learning and growth, diving deep into HTML, CSS, JavaScript, and React to craft intuitive user interfaces.</h5>
